...
class LocalString extends Translations {
  @override
  // TODO: implement keys
  Map<String, Map<String, String>> get keys => {'sp': {
  ...
  AppStrings.strPleaseCheckYourInternetConnectivity: "Por favor verifique su conectividad a Internet.",
  ...
  AppStrings.fillLoginDetail: "Complete los detalles a continuación para iniciar sesión en su cuenta.",
  ...
  AppStrings.fillDetail: "Complete los detalles a continuación para crear su cuenta.",
  ...
  AppStrings.forgetPleaseEnterEmail: "Ingrese la dirección de correo electrónico vinculada con su cuenta y le enviaremos un enlace.",
  //Reset
  AppStrings.reset: "Reiniciar",
  AppStrings.resetcreatePassword: "Crear nueva contraseña",
  AppStrings.resetNewPasswordMustUnique: "Su nueva contraseña debe ser única de las utilizadas anteriormente.",
  ...
  //Add Property
  AppStrings.addPropertiesForInspection: "Agregar propiedades para inspección",
  AppStrings.youHaveNotAddedPropertyYet: "Aún no has agregado ninguna propiedad. Toque el botón de abajo para agregar.",
  ...
  AppStrings.trackYourInspection: "Realice un seguimiento de su inspección",
  AppStrings.reschedule: "Reprogramar",

  //Select Cateories
  AppStrings.categories: "Categorías",
  AppStrings.pleaseSelectCategory: "Seleccione a continuación la categoría que desea.",

  //Inspection List

  AppStrings.pleaseSelectInspections: "Seleccione a continuación las inspecciones que desee.",
  AppStrings.schedule: "Cronograma",
  AppStrings.fillCategoryForm: "Complete el siguiente formulario para su inspección. Puede seleccionar múltiples franjas horarias.",
  AppStrings.contactPersonInformation: "Información de la persona de contacto",
  AppStrings.description: "Descripción",
  AppStrings.searchCategoryAndInspection: "Buscar por categoría y nombre de inspección",
  ...
  AppStrings.accessWasPreviouslyDenied: "El acceso fue previamente denegado",
  AppStrings.areYouWantDelete: "¿Estás seguro de que quieres eliminar esta propiedad?",
  AppStrings.areYouWantLogout: "¿Estás seguro de que quieres cerrar sesión?",
  ...
  AppStrings.areYouSureYouWantToCanelThisInspection: "¿Está seguro de que desea cancelar esta inspección? Toque el botón SÍ para cancelar.",
  ...
  ErrorMessages.emailIsEmpty: "Por favor introduzca su correo electrónico.",
  ErrorMessages.emailIsNotValid: "Por favor introduzca un correo electrónico válido.",
  ErrorMessages.firstNameIsEmpty: "Por favor, introduzca su nombre de pila.",
  ErrorMessages.firstNameMatch: "Su nombre debe tener al menos dos letras y ningún carácter inusual.",
  ErrorMessages.lastNameMatch: "Su apellido debe tener al menos dos letras y ningún carácter inusual.",
  ErrorMessages.lastNameIsEmpty: "Por favor ingrese su apellido.",
  ErrorMessages.addressIsEmpty: "Por favor ingrese su dirección.",
  ErrorMessages.phoneIsEmpty: "Por favor, introduzca su número de teléfono.",
  ErrorMessages.phoneValid: "Por favor ingrese un número de teléfono válido.",
  ErrorMessages.passwordIsEmpty: "Por favor, introduzca su contraseña.",
  ErrorMessages.newPasswordIsEmpty: "Por favor ingrese su nueva contraseña.",
  ErrorMessages.oldPasswordIsEmpty: "Por favor ingrese su antigua contraseña.",
  ErrorMessages.confirmPasswordIsEmpty: "Por favor ingrese su contraseña de confirmación.",
  ErrorMessages.passwordLength: "La contraseña debe contener 8 caracteres con combinaciones (Una mayúscula, una letra minúscula, un número y un carácter especial).",
  ErrorMessages.passwordMatches: "La contraseña y la contraseña de confirmación no coinciden.",
  ErrorMessages.restPasswordMatches: "La contraseña nueva y la contraseña confirmada no coinciden.",
  // ErrorMessages.noDataFound: "No data found",
  ErrorMessages.otpIsEmpty: "Por favor ingrese su otp.",
  ErrorMessages.pleaseSelectAppLanguage: "Seleccione el idioma de la aplicación.",
  ErrorMessages.pleaseEnter4DigitOtp: "Por favor ingrese su OTP.",
  ErrorMessages.otpIsIncorrect: "Otp es incorrecto.",
  ErrorMessages.pleaseEnterCompleteOTP: "Por favor ingresa una OTP válida.",
  ...
  ErrorMessages.pleaseEnterZipCode: "Por favor ingrese el código postal.",

//add property

  ErrorMessages.propertyEmty: "Por favor ingrese el nombre de la propiedad.",
  ...
  InspectionListStatus.inspectorIsNotAssignedYet: "El inspector no está asignado todavía.",
  ...
  AppStrings.isAssignedAndInspectionIsScheduledAt: "está asignado y la inspección está programada en",
  AppStrings.youHaveRescheduledTheInspectionAt: "Ha reprogramado la inspección en",
  AppStrings.youHaveCanceledTheinspection: "Ha cancelado la inspección.",
  AppStrings.canceledTheInspection: "Canceló la inspección",
  AppStrings.rescheduledTheInspectionAt: "reprogramó la inspección en",
  AppStrings.isOnTheWayForInspection: "está en camino para la inspección",
  AppStrings.hasStartedTheInspection: "ha iniciado la inspección",
  AppStrings.hasCompletedTheInspctionAndNowWaitForTheReport: "Ha completado la inspección y ahora espera el informe.",
  AppStrings.hasSubmittedTheReportCorrectionIsRequired: "ha presentado el informe. Se requiere corrección, consulte el informe desde aquí",
  AppStrings.hasSubmittedTheReportYourInspectionIsApproved: "ha presentado el informe. Su inspección está aprobada. Por favor vea el informe desde aquí",
