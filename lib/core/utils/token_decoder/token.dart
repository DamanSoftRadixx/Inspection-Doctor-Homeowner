...
class Data {
  ...
  Data.fromJson(dynamic json) {
    ...
    countyId = json['county_id'] != null ? json['county_id'].cast<String>() : [];
    categoryId = json['category_id'] != null ? json['category_id'].cast<String>() : [];
    documents = json['documents'] != null ? json['documents'].cast<String>() : [];
    documentUploaded = json['documentUploaded'] != null ? json['documentUploaded'].cast<String>() : [];
